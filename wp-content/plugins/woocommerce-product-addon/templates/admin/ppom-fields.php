		        ...
		        <table class="table ppom_field_table  table-striped">
	                ...
	                ?>
	                        ...
	                        <tr class="row_no_<?php echo esc_attr($f_index); ?>" id="ppom_sort_id_<?php echo esc_attr($f_index); ?>">
                                ...
                                <td>
                                    <button class="btn  ppom_copy_field" data-field-type="<?php echo esc_attr($field_type); ?>" title="<?php _e('Copy Field',"ppom"); ?>" id="<?php echo esc_attr($f_index); ?>"><span class="dashicons dashicons-admin-page"></span></span></i></button>
                                    <button class="btn ppom-edit-field" data-modal-id="ppom_field_model_<?php echo esc_attr($f_index); ?>" id="<?php echo esc_attr($f_index); ?>" title="<?php _e('Edit Field',"ppom"); ?>"><span class="dashicons dashicons-edit"></span></button>
                                </td>
	                        </tr> 
	                        <?php   
	                        $ppom_field_index = $f_index;
