...
const PPOM_Validate = {
    ...
    field_meta: ppom_input_vars.field_meta.filter(f => f.required === "on" ),
    passed: true,
	...
	field_has_valid_data(field) {
        ...
        const ppom_type = field.type === 'imageselect' ? 'imageselect' : PPOM_Validate.get_input_dom_type(data_name);
        let element_value = '';
